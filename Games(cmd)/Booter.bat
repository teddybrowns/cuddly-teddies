...
echo 7} Start System32                                                 =
echo.                                                                  =
echo 8} Crash your Computer                                            =
echo 9} To Network Connection                                          =
echo.                                                                  = 
echo 10}Youtube                                                        =
echo 11}Roblox                                                         =
echo 12}Joox                                                           =
echo.                                                                  =
echo 13}Mini Games                                                     =
echo ===================Thank for using this Program====================
set /p select=
if %select% EQU 1 goto About Booster
...
if %select% EQU 9 goto Network
if %select% EQU 10 goto Youtube
if %select% EQU 11 goto Roblox
if %select% EQU 12 goto Joox
if %select% EQU 13 goto Mini Games
:About Booster
title About ComputerBooter V1.3
color E
cls
echo.
echo Support me, Please!
echo ABOUT COMPUTER-BOOTER v1.3
echo (BATCH FILE)
echo.
echo This program is created by PPK
echo.
echo This Program make your Computer more easier to use!
echo.
echo Enjoy!
echo.
echo 1}back
echo 2}Support
set /p num=
if %num% EQU 1 goto Main1
if %num% EQU 2 goto Supports
:Exit
Exit
goto Exit
:Shutdown
start C:\Windows\System32\Shutdown.exe -s -t 5 -c "ComputerBooster Will now Shutdown Your Computer"
goto Main1
:Restart
start C:\Windows\System32\Shutdown.exe -r -t 5 -c "ComputerBooster Will now Restart Your Computer" 
goto Main1
:Logoff
start C:\Windows\System32\Shutdown.exe -l -t 5 -c "ComputerBooster Will now Logoff Your Account"
goto Main1
:Control
start Control Panel
goto Main1
:System32
start This C:\Windows\System32
goto Main1
:Crash
...
:Youtube
cls
start Https://www.Youtube.com "Please wait, Loading..."
goto Main1
:Roblox
cls
start Https://www.Roblox.com "Please wait, Loading..."
goto Main1
:Joox
cls
start Https://www.Joox.com "please wait, Loading..."
goto Main1
:Supports
cls
Start C:\Support
...
color 8
echo.
echo 1}Noughts and Crosses
echo 2}Snake Game
echo 3}Back
echo .
set /p mm=
if %mm% == 1 goto Noughts and Crosses
if %mm% == 2 goto Snake Game
if %mm% == 3 goto Main1
...
:titleScreen
    ...
    :askP1Type
        set p1Type=
        set /p p1Type="Player 1 - Human or computer? [H/B] - "
        if /i "!p1Type!"=="C" goto askP2Type
        if /i "!p1Type!"=="B" goto askP2Type
        if /i "!p1Type!"=="EXIT" (
            set EXIT=1
            exit /b
        )
